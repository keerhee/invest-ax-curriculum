...
| **SP** | KIS 모의투자 | OAuth · HashKey · 한국 주식 · 호가 단위 | 🟢 |
...
│   ├── W1_data_collection.html
│   ├── W2_technical_indicators.html
│   ├── W3_news_sentiment.html
│   ├── W4_chart_vision.html
│   ├── W5_scheduling_rag.html
│   ├── W6_hybrid_rag.html
│   ├── W7_multi_agent.html
│   ├── W8_paper_trading.html
│   └── SP_kis_korea.html
├── W1 데이터수집/                   # n8n 워크플로우 + 시트
│   ├── W1.json
│   └── W1_종목마스터.xlsx
├── W2 기술적지표/  …  (W3~W8 동일 패턴)
└── SP KIS모의투자/
```
